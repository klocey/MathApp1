THEME_DATA = {
    ...
    "K-Pop DH": {
        ...
        "accent_color": "#b51ac1",   # Powerpuff Pink
        "button_shadow": "#b34ec4",
        "question_border": "#f4b1c2",# Buttercup Green
        "characters": ["Rumi", "Mira", "Zoey", "Jinu", "Gwi-Ma", "Celine", "Bobby"],
        ...
        "gifs": [
            ...
            "kpdh/5.gif", "kpdh/6.gif", "kpdh/7.gif", "kpdh/8.gif",
            "kpdh/9.gif", "kpdh/10.gif", "kpdh/11.gif", "kpdh/12.gif",
            "kpdh/13.gif", "kpdh/14.gif", "kpdh/15.gif", "kpdh/16.gif",
            "kpdh/17.gif", "kpdh/18.gif", "kpdh/19.gif", "kpdh/20.gif",
            "kpdh/21.gif", "kpdh/22.gif", "kpdh/23.gif", "kpdh/24.gif",
            "kpdh/25.gif", "kpdh/26.gif", "kpdh/27.gif", "kpdh/28.gif",
            "kpdh/29.gif", "kpdh/30.gif", "kpdh/31.gif", "kpdh/32.gif",
            "kpdh/33.gif", "kpdh/34.gif", "kpdh/35.gif", "kpdh/36.gif",
            ],
        "templates": {
            "+": [
                "Rumi practiced her center dance moves for {num1} minutes before vocal training and {num2} minutes after. How many minutes did she practice in total?",
                "Mira bought {num1} glowing neon light sticks for the Seoul concert, and Zoey brought {num2} more. How many light sticks do they have altogether?",
                "Rumi defeated {num1} low-level shadow demons in the alleyway and {num2} more on the skyscraper roof. How many demons did she banish?",
                "{name} bought {num1} {item} at the convenience store. Then, {friend} grabbed another {num2} {item}! How many do they have now?",
                "Celine designed {num1} sparkling stage outfits for the comeback show and {num2} outfits for the music video. How many outfits did she design total?",
                "Bobby loaded {num1} sound speakers onto the tour bus and Gwi-Ma rolled {num2} more speakers over. How many speakers are loaded in total?",
                "The group received {num1} fan letters from international fans and {num2} letters from local fans today. How many total fan letters arrived?",
                "During the concert opener, {num1} pink strobe lights flashed on stage followed by {num2} purple lasers. How many light sources flashed altogether?",
                "Mira tracked down {num1} hidden demon energy signatures in the subway station and {num2} signatures near the broadcast studio. How many did she track?",
                "Zoey mixed {num1} drops of pastel hair dye with {num2} drops of bright neon pink dye for her new look. How many drops did she use total?",
                "The band's new music video gained {num1} million views in its first hour and {num2} million views in the second hour. How many total millions of views did it get?",
                "Gwi-Ma hid {num1} magical purification talismans under the stage floorboards and {num2} talismans near the microphones. How many talismans were hidden?",
                "Jinu spent {num1} hours tuning his spirit-blade guitar and {num2} hours practicing his bass lines. How many hours did he spend total?",
                "Celine ordered {num1} pairs of silver combat boots and {num2} pairs of white high-tops for the backup dancers. How many pairs of shoes were ordered?",
                "Rumi sang {num1} high notes during morning soundcheck and {num2} high notes during the live concert performance. How many high notes did she hit total?",
                "A pre-order event sold {num1} limited edition vinyl albums on Friday and {num2} albums on Saturday. How many vinyl albums were sold altogether?",
                "Bobby found {num1} spirit-trapping headphones in the studio cabinet and {num2} more in his equipment duffel bag. How many headphones does he have?",
                "The security team set up {num1} barricades at the front entrance and {num2} barricades at the backstage VIP gate. How many barricades were set up total?",
                "Zoey customized her stage microphone with {num1} sparkly rhinestones and {num2} metallic stars. How many decorations did she add total?",
                "Before the show, {name} ate {num1} {item} and then shared {num2} {item} with the rest of the staff. How many did they consume in total?",
                "The group's choreography has {num1} sharp synchronized hand-moves and {num2} high-energy jumps. How many total moves are in the routine?",
                "Mira printed {num1} exclusive photo-cards of the vocal line and {num2} photo-cards of the rap line. How many total photo-cards were printed?",
                "An energy sensor detected {num1} phantom portals opening in the parking garage and {num2} portals in the main lobby. How many portals opened total?",
                "Jinu collected {num1} broken demon horn fragments after the battle, and Rumi found {num2} more fragments. How many did they collect altogether?"
            ],
            "-": [
                "Zoey brought {num1} shiny souvenir badges to pass out to fans, but she already gave away {num2} of them. How many badges does she have left?",
                "A group of {num1} malicious glitched spirits tried to sabotage the soundboard, but Jinu purified {num2} of them instantly. How many spirits are left?",
                "Rumi had {num1} spare microphone batteries in her vanity case, but {num2} of them ran out of power during rehearsals. How many working batteries are left?",
                "{name} had {num1} {item} for the group's late-night studio snack, but Gwi-Ma sneaked in and ate {num2} of them! How many are left?",
                "Celine had {num1} rolls of holographic fabric to make stage capes, but she used {num2} rolls for the group leader's outfit. How many rolls are left?",
                "The tour bus had {num1} gallons of specialized spirit-fuel, but a long drive through a demon zone drained {num2} gallons. How many gallons are left?",
                "Mira had {num1} glow-in-the-dark hair clips for the performance, but she dropped {num2} of them underneath the vanity mirror. How many clips does she keep?",
                "The agency printed {num1} promotional posters for the World Tour, but {num2} of them had a typo and had to be recycled. How many posters are ready?",
                "Bobby booked {num1} practice rooms for the weekend, but the dancers only needed {num2} rooms to finish the choreography. How many rooms are left open?",
                "A giant shadow fiend had {num1} dark shield layers active, but Rumi's sonic high note shattered {num2} shield layers instantly. How many layers are left?",
                "Zoey was carrying {num1} neon light rings in her backpack, but she handed {num2} of them to waiting fans in the front row. How many rings does she have left?",
                "The security database had {num1} suspicious entry logs, but Celine checked the footage and cleared {num2} of them as false alarms. How many logs still need checking?",
                "Jinu possessed {num1} aura-charging crystals, but he expended the energy of {num2} crystals to lock a dimensional rift shut. How many crystals are left?",
                "The stadium had {num1} VIP tickets available online, but excited fans bought up {num2} of them within the first five seconds. How many VIP tickets are left?",
                "Gwi-Ma gathered {num1} magical berries from the spirit world, but he accidentally dropped {num2} of them into a bowl of spicy ramyeon. How many berries are left?",
                "Mira's digital tablet had {num1} demon tracking apps running, but she closed {num2} apps to save her battery life before the ambush. How many apps are left running?",
                "A backup dancer memorized {num1} difficult formations for the title track, but they forgot {num2} formations when the music suddenly speeded up. How many do they remember?",
                "The merchandise booth started with {num1} signed black hoodies. By the end of the night, fans purchased {num2} hoodies. How many hoodies are left?",
                "Celine setup {num1} sewing machines in the design room, but {num2} machines jammed up while working on thick leather jackets. How many machines are still working?",
                "Rumi wrote {num1} lyrical lines for the album's B-side track, but she decided to cross out {num2} lines because they didn't rhyme. How many lines are left?",
                "The training center had {num1} water coolers filled for the idols, but the intense dance squad emptied {num2} coolers before noon. How many coolers are left?",
                "Bobby tracked {num1} glitch particles floating in the recording booth, but he used a plasma vacuum to clear away {num2} particles. How many are left?",
                "A stadium spotlight array had {num1} individual bulb pods, but a power surge blew out {num2} pods right before the grand finale. How many bulbs are still shining?",
                "{name} packed {num1} {item} inside their travel luggage box, but they handed out {num2} of them to hungry staff members at the airport. How many do they have left?"
            ],
            "*": [
                "The group performs {num1} shows per week. If each show requires exactly {num2} outfit changes for the members, how many outfits are worn total?",
                "Jinu uses special dual-blades that strike {num1} times per second. If he fights a demon for {num2} seconds, how many total strikes does he make?",
                "Mira bought {num1} boxes of light sticks. If each box contains exactly {num2} neon light sticks, how many light sticks did she buy in total?",
                "{name} bought {num1} bags of snacks. If each bag contains exactly {num2} {item}, how many individual pieces of food do they have altogether?",
                "Zoey practices her rap verses in {num1} speed sets. If each speed set contains exactly {num2} syllables, how many total syllables does she rap?",
                "Celine lined up {num1} rows of clothing racks. If each rack holds exactly {num2} sparkling idol jackets, how many jackets are ready for the show?",
                "The choreography features {num1} dance formations. If the dancers spend exactly {num2} minutes perfecting each formation, how many minutes do they train?",
                "Bobby configures {num1} wireless frequency bands. If each band connects to exactly {num2} security cameras, how many cameras are being monitored total?",
                "Rumi recorded {num1} vocal layers for the chorus harmony. If each vocal layer takes up {num2} megabytes of computer space, how many megabytes were saved?",
                "A fan club made {num1} rows of banners. If each row contains exactly {num2} glowing fan banners, how many banners are hanging in the arena?",
                "Gwi-Ma jumped across {num1} rooftop structures. If he left exactly {num2} glowing purple footprints on every single roof, how many footprints are there total?",
                "The world tour will visit {num1} major cities. If the band plans to play exactly {num2} stadium dates in every single city, how many concerts will they perform?",
                "Mira sets up {num1} energy tripwires. If each tripwire requires exactly {num2} plasma micro-batteries to stay active, how many batteries does she need total?",
                "The merchandise company manufactured {num1} crates of identity badges. If each crate holds {num2} badges, how many badges were created in total?",
                "Jinu cleans his training swords using {num1} drops of sacred oil per blade side. If he treats {num2} blade sides, how many drops of oil does he use?",
                "Celine ordered {num1} packages of decorative sequins. If each package contains exactly {num2} shining pink sequins, how many sequins does she have total?",
                "The music show broadcasting station has {num1} stage cameras. If each camera takes exactly {num2} photos per second, how many photos are taken each second?",
                "A premium box set contains {num1} glossy photobooks. If each photobook features exactly {num2} high-definition pictures of the band, how many pictures are there total?",
                "The tour bus has {num1} engine cylinders. If each cylinder requires exactly {num2} mechanical check-ups per month, how many check-ups are performed total?",
                "Zoey designed {num1} custom sticker sheets for fans. If each sheet has exactly {num2} cartoon drawings of Gwi-Ma, how many stickers did she print?",
                "The security team deployed {num1} patrol groups around the stadium. If each group contains exactly {num2} high-tech guard drones, how many drones are patrolling?",
                "Rumi practiced her signature stage smile in front of {num1} mirrors. If she stood in front of each mirror for {num2} minutes, how many minutes did she spend?",
                "Bobby purchased {num1} storage cases for sound cables. If each storage case keeps exactly {num2} gold-plated jack cables organized, how many cables are there total?",
                "During a fan-sign event, {num1} tables were set up. If exactly {num2} excited fans lined up at every single table, how many total fans attended the event?"
            ],
            "/": [
                "Princess Celine has {num1} sparkling hair gems that she divides completely evenly among {num2} music video styles. How many gems are used per style?",
                "Jinu recovered {num1} stolen demon containment vials. If he stores them completely evenly inside {num2} secure wall cases, how many vials go in each case?",
                "Rumi has {num1} custom vocal lozenges to distribute. If she shares them completely evenly among {num2} bandmates, how many does each idol receive?",
                "{name} ordered {num1} {item} from a delivery service and splits them evenly among {num2} hungry dancers. How many does each dancer get?",
                "Mira has {num1} city tracking maps to hand out. She divides them completely evenly among {num2} security vehicles. How many maps does each vehicle get?",
                "Zoey sorted {num1} backup audio tracks into {num2} organized digital directories. If each directory gets the same amount, how many tracks are in a directory?",
                "Gwi-Ma has {num1} magical star candy treats. He splits them completely evenly into {num2} small snack bowls. How many candies go into each snack bowl?",
                "The dance studio has {num1} hours of open practice time to split up completely evenly among {num2} trainee squads. How many hours does each squad get?",
                "Bobby has {num1} sound checking monitors to balance. He distributes them completely evenly across {num2} audio tables. How many monitors go on each table?",
                "The wardrobe department has {num1} zipper replacement pulls. They divide them evenly into {num2} costume emergency sewing boxes. How many pulls fit in a box?",
                "An automated ticket machine printed {num1} floor passes. If the passes are divided completely evenly into {num2} pick-up windows, how many passes go to each window?",
                "A choreographer wants to divide {num1} dance steps completely evenly across {num2} bars of music. How many dance steps will be performed per bar?",
                "The fan club has {num1} pink glow-sticks to unpack. If they distribute them completely evenly into {num2} entrance bins, how many glow-sticks go into each bin?",
                "Jinu discovered {num1} corrupted code nodes hidden in the city grid. He divides them evenly among {num2} target trackers to destroy. How many nodes per tracker?",
                "Celine has {num1} silver designer necklaces to display. She places them completely evenly across {num2} glass cases. How many necklaces go into each case?",
                "The record label has {num1} promotional interview slots to schedule. If they divide them completely evenly across {num2} radio stations, how many slots does each get?",
                "Mira collected {num1} distinct samples of shadow residue. She distributes them completely evenly into {num2} analysis tubes. How many samples go into each tube?",
                "A stadium cleaning crew has {num1} rows of concert seats to sweep. If the crew splits up completely evenly across {num2} aisles, how many rows does each aisle group sweep?",
                "Zoey has {num1} spare silver microphone clips. She divides them completely evenly into {num2} equipment bags. How many clips go into each bag?",
                "The marketing team has {num1} high-definition teaser photos to upload. If they split them completely evenly across {num2} social apps, how many photos go on each app?",
                "Rumi has {num1} lyrical rhyme sheets to file away. If she stores them completely evenly into {num2} performance binders, how many sheets go into each binder?",
                "The tour manager bought {num1} custom water bottles for the traveling staff. They split them evenly into {num2} backstage coolers. How many bottles go in each?",
                "Gwi-Ma found {num1} glittery pom-poms behind the stage curtain. He sorts them completely evenly into {num2} toy baskets. How many pom-poms are in a single basket?",
                "The digital recording console has {num1} separate audio channels to organize. Bobby groups them completely evenly into {num2} mixing faders. How many channels map to a fader?"
            ]
        }
        },
    ...
    "Powerpuff Girls": {
        ...
        "gifs": [
            "powerpuff/1.gif", "powerpuff/2.gif", "powerpuff/3.gif", "powerpuff/4.gif",
            "powerpuff/5.gif", "powerpuff/6.gif", "powerpuff/7.gif", "powerpuff/8.gif",
            "powerpuff/9.gif", "powerpuff/10.gif", "powerpuff/11.gif", "powerpuff/12.gif",
            "powerpuff/13.gif", "powerpuff/14.gif", "powerpuff/15.gif", "powerpuff/16.gif",
            "powerpuff/17.gif", "powerpuff/18.gif", "powerpuff/19.gif", "powerpuff/20.gif",
            "powerpuff/21.gif", "powerpuff/22.gif", "powerpuff/23.gif", "powerpuff/24.gif",
            ],
    ...
    "Pokemon": {
        ...
        "gifs": [
            "pokemon/1.gif", "pokemon/2.gif", "pokemon/3.gif", "pokemon/4.gif",
            "pokemon/5.gif", "pokemon/6.gif", "pokemon/7.gif", "pokemon/8.gif",
            "pokemon/9.gif", "pokemon/10.gif", "pokemon/11.gif", "pokemon/12.gif",
            "pokemon/13.gif", "pokemon/14.gif", "pokemon/15.gif", "pokemon/16.gif",
            "pokemon/17.gif", "pokemon/18.gif", "pokemon/19.gif", "pokemon/20.gif",
            "pokemon/21.gif", "pokemon/22.gif", "pokemon/23.gif", "pokemon/24.gif",
            ],
        "templates": {
            "+": [
    ...
    "Adventure Time": {
        ...
        "gifs": [
            "adventuretime/1.gif", "adventuretime/2.gif", "adventuretime/3.gif", "adventuretime/4.gif",
            "adventuretime/5.gif", "adventuretime/6.gif", "adventuretime/7.gif", "adventuretime/8.gif",
            "adventuretime/9.gif", "adventuretime/10.gif", "adventuretime/11.gif", "adventuretime/12.gif",
            "adventuretime/13.gif", "adventuretime/14.gif", "adventuretime/15.gif", "adventuretime/16.gif",
            "adventuretime/17.gif", "adventuretime/18.gif", "adventuretime/19.gif", "adventuretime/20.gif",
            "adventuretime/21.gif", "adventuretime/22.gif", "adventuretime/23.gif", "adventuretime/24.gif",
            ],
        "templates": {
            "+": [
    ...
    "TMNT": {
        ...
        "gifs": [
            "tmnt/1.gif", "tmnt/2.gif", "tmnt/3.gif", "tmnt/4.gif", 
            "tmnt/5.gif", "tmnt/6.gif", "tmnt/7.gif", "tmnt/8.gif", 
            "tmnt/9.gif", "tmnt/10.gif", "tmnt/11.gif", "tmnt/12.gif", 
            "tmnt/13.gif", "tmnt/14.gif", "tmnt/15.gif", "tmnt/16.gif", 
            "tmnt/17.gif", "tmnt/18.gif", "tmnt/19.gif", "tmnt/20.gif", 
            "tmnt/21.gif", "tmnt/22.gif", "tmnt/23.gif", "tmnt/24.gif", 
            ],
    ...
    "Transformers": {
        ...
        "gifs": [
            "transformers/1.gif", "transformers/2.gif", "transformers/3.gif", "transformers/4.gif", 
            "transformers/5.gif", "transformers/6.gif", "transformers/7.gif", "transformers/8.gif", 
            "transformers/9.gif", "transformers/10.gif", "transformers/11.gif", "transformers/12.gif", 
            "transformers/13.gif", "transformers/14.gif", "transformers/15.gif", "transformers/16.gif", 
            "transformers/17.gif", "transformers/18.gif", "transformers/19.gif", "transformers/20.gif", 
            "transformers/21.gif", "transformers/22.gif", "transformers/23.gif", "transformers/24.gif",
            ],
        "templates": {
            "+": [
